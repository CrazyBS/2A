...
/* ** */Column Member_Confidentiality_Code = new Column(StringUtils.isNotEmpty(data.get(ConsistentFields.IS_BLU.toString())) ? "BLU" : StringUtils.isNotEmpty(data.get(ConsistentFields.IS_PHI.toString())) ? "PHI" : "NON",3);
        ...
        Column Member_Primary_Street_Address_1 = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? data.get(SubscriberAddress.SBAD_ADDR1.toString()) : data.get(ConfidentialAddress.ENAD_ADDR1.toString()),70);
        Column Member_Primary_Street_address_2 = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? data.get(SubscriberAddress.SBAD_ADDR2.toString()) : data.get(ConfidentialAddress.ENAD_ADDR1.toString()),70);
        Column Member_Primary_City = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? data.get(SubscriberAddress.SBAD_CITY.toString()) : data.get(ConfidentialAddress.ENAD_CITY.toString()),35);
        Column Member_Primary_State = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? data.get(SubscriberAddress.SBAD_STATE.toString()) : data.get(ConfidentialAddress.ENAD_STATE.toString()),2);
        Column Member_Primary_ZIP_Code = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? StringUtils.substring(data.get(SubscriberAddress.SBAD_ZIP.toString()),0,5) : StringUtils.substring(data.get(ConfidentialAddress.ENAD_ZIP.toString()),0,5),5);
        Column Member_Primary_ZIP_Code_4 = new Column(null == data.get(ConfidentialAddress.ENAD_ADDR1.toString()) ? zipCode4(data.get(SubscriberAddress.SBAD_ZIP.toString()),true) : zipCode4(data.get(ConfidentialAddress.ENAD_ZIP.toString()),true),4);
        Column Member_Primary_Phone_Number = new Column(null == data.get(ConfidentialEmailPhone.ENPH_PHONE.toString()) ? phone(data.get(SubscriberAddress.SBAD_PHONE.toString())) : phone(data.get(ConfidentialEmailPhone.ENPH_PHONE.toString())),10);
        Column Member_Primary_Email_Address = new Column(null == data.get(ConfidentialEmailPhone.ENEM_EMAIL.toString()) ? data.get(SubscriberAddress.SBAD_EMAIL.toString()) : data.get(ConfidentialEmailPhone.ENEM_EMAIL.toString()),70);
        Column Member_Secondary_Street_Address_1 = new Column(data.get("secd_" + SubscriberAddress.SBAD_ADDR1.toString()),70);
        Column Member_Secondary_Street_Address_2 = new Column(data.get("secd_" + SubscriberAddress.SBAD_ADDR2.toString()),70);
        Column Member_Secondary_City = new Column(data.get("secd_" + SubscriberAddress.SBAD_CITY.toString()),35);
        Column Member_Secondary_State = new Column(data.get("secd_" + SubscriberAddress.SBAD_STATE.toString()),2);
        Column Member_Secondary_ZIP_Code = new Column(StringUtils.substring(data.get("secd_" + SubscriberAddress.SBAD_ZIP.toString()),0,5),5);
        Column Member_Secondary_ZIP_Code_4 = new Column(zipCode4(data.get("secd_" + SubscriberAddress.SBAD_ZIP.toString()),false),4);
